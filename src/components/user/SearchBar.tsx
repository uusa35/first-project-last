...
export default function ({ trans }: Props) {
  ...
  return (
    <div className='bg-gray-50 px-4 capitalize'>
      ...
      <div className='mx-auto max-w-3xl px-4  text-center sm:px-6 lg:max-w-7xl lg:px-0'>
        <section
            ...
            <Menu as='div' className='relative inline-block text-left'>
              <div>
                <Menu.Button className='group inline-flex justify-center text-sm font-medium text-gray-700 hover:text-gray-900 capitalize'>
                  {trans.sort}
                  <ChevronDownIcon
                    className='mx-1 h-5 w-5 flex-shrink-0 text-gray-400 group-hover:text-gray-500'
                    aria-hidden='true'
                  />
                </Menu.Button>
              </div>
